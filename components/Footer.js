...
export default async function Footer() {
  ...
  return (
    <footer className="bg-forest text-ivory">
      <div className="container-bal-stars-sofa py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div>
          <p className="font-display text-2xl mb-3"></p>Bali Stars Sofa
      ...
      <p className="text-center text-xs text-ivory/50 py-6">
        © {new Date().getFullYear()} Bali Stars Sofa. Seluruh hak cipta dilindungi.
      </p>
    </footer>
  );
}
