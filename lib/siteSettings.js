const STORAGE_KEY = "bali-star-sofa-site-settings";
...
export const defaultHomeSettings = {
  introEyebrow: "Selamat Datang di Bali Star Sofa",
...
export const defaultAboutSettings = {
  ...
  heroTitle: "Tentang Bali Star Sofa",
  heroSubtitle:
  ...
  sectionBody1:
    "Bali Star Sofa hadir sebagai tempat belanja retail online yang menghadirkan produk-produk pilihan untuk kebutuhan fashion, rumah tangga, kecantikan, dan gaya hidup sehari-hari.",
  sectionBody2:
  ...
  values: [
    {
      ...
      desc: "Setiap produk melewati proses seleksi ketat sebelum layak disebut bagian dari koleksi Bali Star Sofa.",
    },
    {
    ...
    if (!error && data?.length) {
      ...
      return {
        ...
        home: {
          ...
          ctaLabel: map.home_cta_label || fallback.home.ctaLabel,
        },
        about: {
...
export async function saveSiteSettings(supabaseClient, { whatsappNumber, heroSlides, home, about }) {
  ...
  const payload = [
    ...
    { key: "home_cta_label", value: home?.ctaLabel || "" },
